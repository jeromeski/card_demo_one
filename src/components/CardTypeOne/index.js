...
import img from "../../assets/images/card-room-430x300-7.jpg";
import avatar from "../../assets/images/card-host-150x150-7.jpg";
          ...
          <div className="media-body item-body clearfix">
            ...
            <ul className="item-amenities">
              <li>
                ...
                <span className="total-beds">{bedrooms}</span>{" "}
                <span className="item-label">Bedrooms</span>
              </li>
              <li>
                <FontAwesomeIcon icon={faShower} />{" "}
                <span className="total-baths">{baths}</span>{" "}
                <span className="item-label">Baths</span>
              </li>
              <li>
                <FontAwesomeIcon icon={faUser} />{" "}
                <span className="total-guests">{guests}</span>{" "}
                ...
                <div className="item-tools">
                  <div className={`btn-group dropup ${isOpen ? "open" : ""}`}>
                    ...
                    <ul className="dropdown-menu">
                      <li>
                        <a
                          className="homey_compare compare-346"
                          href
                          data-listing_id={346}
                        >
                          Compare
